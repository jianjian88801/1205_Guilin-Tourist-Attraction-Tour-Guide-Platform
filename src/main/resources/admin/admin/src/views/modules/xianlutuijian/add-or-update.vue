  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xianlubianhao" label="线路编号" prop="xianlubianhao">
              <el-input v-model="ruleForm.xianlubianhao" 
                placeholder="线路编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预订价格" prop="yudingjiage">
          <el-input v-model="ruleForm.yudingjiage" 
              placeholder="预订价格" clearable  :readonly="ro.yudingjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预订价格" prop="yudingjiage">
              <el-input v-model="ruleForm.yudingjiage" 
                placeholder="预订价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="线路详情" prop="xianluxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xianluxiangqing" label="线路详情" prop="xianluxiangqing">
                    <span v-html="ruleForm.xianluxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xianluxiangqing = this.ruleForm.xianluxiangqing.replace(reg,'../../../springbootr6il1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xianlutuijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xianlutuijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
